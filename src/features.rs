...
impl Features {
    ...
    pub fn edax() -> Self {
        let features = vec![
            ...
            Feature::new("edge_h_right2", vec![31, 39, 47, 55, 63, 54, 62, 61, 60, 59]), // H4,H5,H6,H7,H8,G7,G8,F8,E8,D8
            ...
            Feature::new("ext_corner_a8", vec![56, 58, 59, 49, 50, 51, 52, 53, 42, 63]), // A8,C8,D8,C7,D7,E7,F7,E8,F8,H8
